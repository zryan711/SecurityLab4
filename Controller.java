/*
	Example Java JSP web application controller for a shipping inventory tracking system. 

	Note: this code was modified with some vulnerabiltiies, but the vast majority of these mistakes were already there.

	Assume that this code already runs. We won't be setting it up to run. 
*/
...
public class Controller extends HttpServlet {
			...
			try{
				...
				if(mQuery.toLowerCase().contains("insert into shipments") || mQuery.toLowerCase().contains("update shipments")){
					...
					for(String word: brokenString){
						try{
							// Javascript limits this field to an integer less than 5000.
	...
	public hashcode(){
		return Controller.getClass().hashcode();
	}
